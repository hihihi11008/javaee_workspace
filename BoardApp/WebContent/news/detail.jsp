...
<%
	String news_id = request.getParameter("news_id");//파라미터받기
	
	NewsDAO dao = new NewsDAO();
	News news = dao.select(Integer.parseInt(news_id));//데이터한건 가져오기 
	
	//이게시물에 딸려있는 모든 코멘트 게시물 가져오기 
	CommentsDAO commentsDAO = new CommentsDAO();
	List<Comments> list = commentsDAO.selectAll(Integer.parseInt(news_id));
%>
<!DOCTYPE html>
<html>
<head>
