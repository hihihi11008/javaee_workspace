...
/*
JNDI 란? 
Java Naming Directory Interface : 어떤 정보를 프로그래밍 언어인 자바코드에 넣지 말고
외부의 xml과 같은 자우너으로 관리하는 방법 (즉 자바코드안에 설정정보를 넣지말고, 코드 밖으로 빼서 유지관리하자 )
*/
...
Connection conn = ds.getConnection(); //커넥션풀로부터 하나의 커넥션을 얻는 작업!//기존에 있는걸 빌려온것 
