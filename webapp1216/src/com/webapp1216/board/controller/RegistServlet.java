/*
 *jsp나 servletㄷ 둘 다 웹서버에서 해석 및 실행되어지므로 글 등록 요청을 처리할때는
...
public class RegistServlet extends HttpServlet{
   ...
   //글쓰기를 처리하는 서블릿이므로 ,클라이언트의 요청이 post로 들어온다 따라서 doXXX형중에서 doPost로받자
   //참고)doXX형 메서드는 service()메서드에 의해 호출된다.이때, 요청,응답 객체가 전달..
