 ...
 * 이 클래스는 특히 new 할때마다 인스턴스가 생성될것이고, 그렇게되면 SqlSessionFactory로 다수가 
 * 메모리에 올라오므로, 메모리누수가 될것임, 따라서 SingleTon으로 정의하자 
 * */
...
public class MybatisConfigManager {
	...
	private static MybatisConfigManager instance; // 전세계에서 공통적으로 사용 
